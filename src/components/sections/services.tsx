...
// Map DB icon names to SVG paths
const iconPaths: Record<string, string> = {
  ...
  tag: "M7.5 7.5h-.75A2.25 2.25 0 0 0 4.5 9.75v7.5a2.25 2.25 0 0 0 2.25 2.25h7.5a2.25 2.25 0 0 0 2.25-2.25v-7.5a2.25 2.25 0 0 0-2.25-2.25h-.75m0-3-3-3m0 0-3 3m3-3v11.25m6-2.25h.75a2.25 2.25 0 0 1 2.25 2.25v7.5a2.25 2.25 0 0 1-2.25 2.25h-7.5a2.25 2.25 0 0 1-2.25-2.25v-.75",
  megaphone:
  ...
  palette:
    "M4.098 19.902a3.75 3.75 0 0 0 5.304 0l6.401-6.402M6.75 21A3.75 3.75 0 0 1 3 17.25V4.125C3 3.504 3.504 3 4.125 3h5.25c.621 0 1.125.504 1.125 1.125v4.072M6.75 21a3.75 3.75 0 0 0 3.75-3.75V8.197M6.75 21h13.125c.621 0 1.125-.504 1.125-1.125v-5.25c0-.621-.504-1.125-1.125-1.125h-4.072M10.5 8.197l2.88-2.88c.438-.439 1.15-.439 1.59 0l3.712 3.713c.44.44.44 1.152 0 1.59l-2.88 2.88M6.75 17.25h.008v.008H6.75v-.008Z",
  scissors:
    "m7.848 8.25 1.536.887M7.848 8.25a3 3 0 1 1-5.196-3 3 3 0 0 1 5.196 3Zm1.536.887a2.165 2.165 0 0 1 1.083 1.839c.005.025.005.049.005.074a2.165 2.165 0 0 1-1.083 1.839m0-3.752-2.768 4.783a.75.75 0 0 0 .651 1.13h7.477a.75.75 0 0 0 .651-1.13l-2.768-4.783m0 0 1.536-.887M9.384 9.137a3 3 0 1 1 5.196-3 3 3 0 0 1-5.196 3Z",
  camera:
                ...
                <div className="h-12 w-12 rounded-lg bg-primary/10 text-primary flex items-center justify-center mb-3 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                  ...
                  >
                    <path
                      ...
                      d={iconPaths[service.icon ?? ""] || defaultIconPath}
                    />
                  </svg>
                </div>
