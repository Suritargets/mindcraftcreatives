  ...
  return (
    <>
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        {mainNav.map((item, i) => {
          if ("section" in item) {
            if (collapsed) return <div key={`section-${i}`} className="pt-4 pb-1"><Separator /></div>;
            return (
      ...
      <div className="p-3 border-t space-y-1">
        ...
        {/* User */}
        {!collapsed && (
          <div className="flex items-center gap-3 px-3 py-3 mt-2 border-t">
        ...
        {collapsed && (
          <div className="flex justify-center py-3 mt-2 border-t">
            <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center" title="Admin">
              <span className="text-xs font-bold text-muted-foreground">MC</span>
            </div>
          </div>
        )}
...
export function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile top bar */}
      <div className="fixed top-0 left-0 right-0 z-40 flex items-center gap-3 border-b bg-background p-3 lg:hidden">
        <button
      ...
      <aside
        className={cn(
          "hidden lg:flex shrink-0 border-r bg-background flex-col h-screen sticky top-0 transition-all duration-200",
