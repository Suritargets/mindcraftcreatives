...
const defaultWidgets: Widget[] = [
  { id: "w1", name: "WhatsApp Chat Button", type: "whatsapp", enabled: true, position: "floating", config: { nummer: "+5978581854", bericht: "Hallo! Ik heb een vraag.", label: "Chat met ons", kleur: "#25D366" } },
  { id: "w2", name: "Offerte CTA Banner", type: "cta-banner", enabled: true, position: "footer", config: { titel: "Offerte nodig?", tekst: "Vraag vandaag nog een vrijblijvende offerte aan!", knopTekst: "Offerte Aanvragen", link: "#contact" } },
  { id: "w3", name: "Nieuwsbrief Aanmelding", type: "newsletter", enabled: false, position: "footer", config: { titel: "Blijf op de hoogte", tekst: "Ontvang onze nieuwste aanbiedingen en updates.", placeholder: "Uw e-mailadres", knopTekst: "Aanmelden" } },
  { id: "w4", name: "Social Media Links", type: "social", enabled: true, position: "footer", config: { facebook: "https://www.facebook.com/mindcraftcreatives", instagram: "", whatsapp: "https://wa.me/5978581854", linkedin: "" } },
  { id: "w5", name: "Cookie Melding", type: "custom", enabled: true, position: "popup", config: { titel: "Cookies", tekst: "Deze website gebruikt cookies om uw ervaring te verbeteren.", knopTekst: "Accepteren", link: "/privacy" } },
];
                ...
                <>
                  ...
                  <div className="p-5 space-y-4 bg-muted/10">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <Button variant="destructive" size="sm" onClick={() => deleteWidget(widget.id)} className="gap-1 text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button size="sm" onClick={() => handleSave(widget.id)} className="gap-1.5">
                          <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
