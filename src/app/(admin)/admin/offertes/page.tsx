...
const initialQuotes: QuoteRequest[] = [
  {
    id: "Q-001",
    company: "TeleSur N.V.",
    contact: "Ricardo Martinus",
    email: "r.martinus@telesur.sr",
    phone: "+597 8123456",
    date: "2026-03-28",
    status: "nieuw",
    items: [
      { product: "Custom T-Shirt Bedrukt", quantity: 200, notes: "Wit, logo voorkant" },
      { product: "Baseball Cap Custom", quantity: 100 },
    ],
  },
  {
    id: "Q-002",
    company: "Fernandes Bottling",
    contact: "Samira Djoe",
    email: "s.djoe@fernandes.sr",
    phone: "+597 8654321",
    date: "2026-03-26",
    status: "in-behandeling",
    items: [
      { product: "RVS Waterfles", quantity: 500, notes: "Blauw, logo gegraveerd" },
      { product: "Koeltas Bedrukt", quantity: 200 },
      { product: "Katoenen Tote Bag", quantity: 300 },
    ],
    internalNotes: "Klant wil sample voor goedkeuring. Levertijd besproken: 3 weken.",
  },
  {
    id: "Q-003",
    company: "Hakrinbank",
    contact: "Dennis Wongsoredjo",
    email: "d.wong@hakrinbank.sr",
    phone: "+597 8111222",
    date: "2026-03-25",
    status: "offerte-verstuurd",
    items: [
      { product: "Polo Shirt Met Logo", quantity: 150, notes: "Navy, borduring links borst" },
      { product: "Notitieboek A5 Custom", quantity: 300 },
      { product: "Bedrukte Pen", quantity: 500 },
    ],
    internalNotes: "Offerte verstuurd op 26/03. Wacht op goedkeuring.",
  },
  {
    id: "Q-004",
    company: "Assuria N.V.",
    contact: "Michelle Blokland",
    email: "m.blokland@assuria.sr",
    phone: "+597 8999888",
    date: "2026-03-20",
    status: "afgerond",
    items: [
      { product: "Roll-up Banner 85x200", quantity: 5 },
      { product: "Beachflag Custom", quantity: 10 },
    ],
    internalNotes: "Betaling ontvangen. Geleverd op 27/03.",
  },
  {
    id: "Q-005",
    company: "Staatsolie",
    contact: "Brian Soerodjmisier",
    email: "b.soero@staatsolie.sr",
    phone: "+597 8444555",
    date: "2026-03-18",
    status: "afgerond",
    items: [
      { product: "Hoodie Met Bedrukking", quantity: 80, notes: "Zwart en grijs" },
      { product: "Power Bank 10000mAh", quantity: 50 },
      { product: "USB Stick Custom", quantity: 100, notes: "16GB, custom vorm" },
      { product: "Sporttas Custom", quantity: 80 },
    ],
  },
  {
    id: "Q-006",
    company: "Surinaamse Brouwerij",
    contact: "Patrick Roelofsen",
    email: "p.roelofsen@srbrouwerij.sr",
    phone: "+597 8777666",
    date: "2026-03-15",
    status: "in-behandeling",
    items: [
      { product: "Keramische Mok Bedrukt", quantity: 1000, notes: "Parbo logo, wit" },
      { product: "Katoenen Tote Bag", quantity: 500 },
    ],
    internalNotes: "Grote order. Leverancier gevraagd voor snellere levertijd.",
  },
  {
    id: "Q-007",
    company: "De Surinaamsche Bank",
    contact: "Anita Ramdat",
    email: "a.ramdat@dsb.sr",
    phone: "+597 8333444",
    date: "2026-03-12",
    status: "offerte-verstuurd",
    items: [
      { product: "Polo Shirt Met Logo", quantity: 200 },
      { product: "Rugzak Met Logo", quantity: 100 },
      { product: "Thermosfles Premium", quantity: 100 },
      { product: "Bedrukte Pen", quantity: 500 },
      { product: "Notitieboek A5 Custom", quantity: 200 },
    ],
  },
];
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b bg-muted/30">
                ...
                <th className="text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Bedrijf</th>
                <th className="text-left text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Contact</th>
                <th className="text-center text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Producten</th>
                <th className="text-center text-xs font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Stuks</th>
              ...
              {filtered.map((quote, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <span className="text-sm font-semibold text-foreground">{quote.company}</span>
                    </td>
                    <td className="px-5 py-3.5">
                      <div>
                        <p className="text-sm text-foreground">{quote.contact}</p>
      ...
      <Sheet open={sheetOpen} onOpenChange={(open) => { if (!open) setSelectedId(null); }}>
        <SheetContent side="right" className="w-full sm:w-[75vw] sm:max-w-none p-0 overflow-y-auto">
          {selected && (
            <div>
              {/* Sheet header */}
              <div className="px-8 lg:px-12 pt-14 pb-5 border-b">
              ...
              {/* Contact info */}
              <div className="px-8 lg:px-12 py-5 border-b">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <a
                    href={`https://wa.me/${selected.phone.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(
                      `Hallo ${selected.contact}, betreft offerte ${selected.id} voor ${selected.company}.`
                    )}`}
                    target="_blank"
