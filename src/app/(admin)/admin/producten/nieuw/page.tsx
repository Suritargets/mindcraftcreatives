          ...
          <CollapsibleCard title="Algemene Informatie" defaultOpen={true}>
            <div className="space-y-4">
              <div>
                ...
                <Input value={name} onChange={(e) => handleNameChange(e.target.value)} className="h-10" placeholder="bijv. Custom T-Shirt Bedrukt" />
              </div>
              <div>
                <label className="block text-sm font-medium text-foreground mb-1.5">Beschrijving</label>
                <Textarea value={description} onChange={(e) => setDescription(e.target.value)} rows={5} className="text-sm" placeholder="Beschrijf het product..." />
              </div>
              <div>
